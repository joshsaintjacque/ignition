...
group :development do
  ...
  gem 'rubocop-capybara', require: false # https://github.com/rubocop/rubocop-capybara
  gem 'rubocop-performance', require: false # https://github.com/rubocop/rubocop-rspec
